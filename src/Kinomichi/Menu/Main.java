...
public class Main {
    public static void main(String[] args) {
        ...
        Menu menuPrincipal = menuBuilder.start("Kinomichi.Menu Principal");
        {
            ...
            /////////////////////////////////////////////////////////////////
            menuBuilder.startMenu("b", "Kinomichi.Menu Secondaire", new InlineVue());// Commencement d'un ajout de sous menu
            {
                menuBuilder.addItem("c", "option 2", getOption2());// ajout d'item au menu
                Menu menu = menuBuilder.startMenu("d", "Kinomichi.Menu 3");// Commencement d'un ajout de sous menu
                {
    ...
    private static Menu getMenu() {
        Menu menuPrincipal = new Menu("Kinomichi.Menu Principal", new MainVue());
        Menu menuSecondaire = new Menu("Kinomichi.Menu Secondaire", new MainVue());
